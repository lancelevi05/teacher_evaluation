...
<aside class="sidebar" role="navigation" aria-label="Main navigation">
    ...
    <nav class="sidebar-nav"><span class="nav-label">ACADEMIC STRUCTURE</span>
        ...
        <a class="nav-item {{ request()->routeIs('departments.*') ? 'active' : '' }}"  href="{{ route('departments.index') }}">
            <svg class="nav-icon" viewbox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                <path d="M3 21h18" />
        ...
        <a class="nav-item" href="{{ route('sections.index') }}">
            ...
            </svg> Manage Sections </a> <span class="nav-label" style="margin-top:12px">Settings</span> <a
            class="nav-item" href="#">
            <svg class="nav-icon" viewbox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
