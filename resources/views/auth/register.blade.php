<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        @csrf
         ...
         <!-- USN -->
        <div>
            <x-input-label for="usn" :value="__('USN')" />
            <x-text-input id="usn" class="block mt-1 w-full" type="text" name="usn" :value="old('usn')" required autofocus autocomplete="usn" />
        ...
        <div>
            ...
            <x-text-input id="mname" class="block mt-1 w-full" type="text" name="mname" :value="old('mame')" required autofocus autocomplete="mname" />
